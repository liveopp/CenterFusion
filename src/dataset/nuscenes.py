...
from utils.ddd_utils import iou3d_global
...
class NuScenes(GenericDataset):
    ...
    def run_eval(self, results, save_dir, n_plots=10, render_curves=False):
        ...
        if task == 'det':
            ...
            os.system('python tools/nuscenes-devkit/python-sdk/nuscenes/eval/detection/evaluate.py new.json '
                      '--output_dir new_out --eval_set mini_val --dataroot ../data/nuscenes/ --version v1.0-mini'
                      '--plot_examples 10 --render_curves 1')
